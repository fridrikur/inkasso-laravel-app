<div class="relative min-h-[60vh]">
    ...
    {{-- FULDSKÆRMS LOADING SPINNER INDTIL SIDEN ER FULDT LOADED --}}
    @if (! $readyToLoad)
        <div wire:init="loadDashboard" class="fixed inset-0 z-40 flex flex-col items-center justify-center bg-slate-950/95 backdrop-blur-md animate-in fade-in duration-300">
            <div class="mx-auto mb-4 h-14 w-14 animate-spin rounded-full border-4 border-indigo-500/20 border-t-indigo-500"></div>
            <h2 class="text-xl font-bold text-white tracking-tight">
                Loading dashboard...
            </h2>
            <p class="mt-1.5 text-sm text-slate-400">
                Henter sager, kreditorer, GDPR-statistik og klargør systemdata...
            </p>
        </div>
    @else
